...
Then, to identify the presence of clustering and examine whether they are concentrated among individuals with the highest h-index or around specifically gendered scholars, the networks were visualized. Further, centrality measures were examined to investigate their correlation to the ego-level variables gender and H-index.



.  Among others, these included the number of nodes, edges, reciprocity, degreee centrality, clustering, density, and path-length. **[INSERT RELEVANT DESCRIPTIVES HERE]**\visualized using graphs 
