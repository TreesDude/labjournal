...
The data for this study was obtained by collecting information from all Sociology and Political Science scholars at all Dutch institutions. During the initial phase of data collection, all important information regarding the author's position, university affiliation, names, IDs, departments, and more was gathered. The coordinator of this course, Jochem Tolsma, has provided a dataset with said information to be used in this project. 'OpenAlex' was used to scrape all published works, including important work-related information such as work id, concepts, citations, abstracts, and subjects, up until 2024 (@Priem2022). From this data, I created a final dataset (n=101) that included all authors from the Sociology and Political Science departments at Radboud University within the time frame of 2015 to 2018. I also included a second wave of data, pertainning to 2019-2024, which is purely included for the sake of running the simulations needed to analyse the data, while the focus remained on the first wave (2015-2018) only. Based on this data collaboration networks were constructed to capture whether two scholars in the sample had collaborated on a publication during a given wave.
