...
Jochem Tolsma and Bas Hofstra use this repository for their Social Network Analysis For Social Scientists course [@SNASS]. <!--- this is a reference, stored in references.bib. It will be automatically added at the bottom of the page --->
