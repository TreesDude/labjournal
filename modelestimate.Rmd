...
R-Manual: in-degree popularity weighted by sender’s V (inPopX) defined
by the sum of values of V for actors h for which there are ties i → j ←
h
...
variable is desired, a new effect is necessary;
