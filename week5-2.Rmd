...
e.g. outdegree (density), called density, three things: evaluation, endowment, and creation
  ...
  Assumption mechanisms to make and breaka a tie are the same so we only use the EVALUATION part 
  
  All these effects are described in the manual of RSiena Chapter 12 (9?) 
