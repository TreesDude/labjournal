...
Oh no, a *kriller* is on the loose!
...
# didnt' make the IV gender butif i Had: 
...
The assumption is: mechanisms to make and break a a tie are the same so WE ONLY USE THE EVALUATION part 
...
Sometimes similartostep  (but here you include specifically the effects you want to look at)2
```{r}
...
```
over time:
inpop: ppl with lots of indegrees will havelot of indegrees later (in population)
...
# DONT GO OVERBOARD!!! & REMAIN FOCUSED!!!